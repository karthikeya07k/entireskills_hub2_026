...
import { 
  ...
  Scissors, Shirt, Utensils, ChefHat, Store, Smartphone, Wrench, Briefcase, Zap, Rocket, Send 
} from 'lucide-react';
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-8 shadow-md sticky top-24 space-y-6">
            <div>
              ...
              <p className="text-sm text-slate-400 mt-2 font-medium leading-relaxed">
                Select or modify the practical offline tracks that align with your background. Submission triggers real-time matching.
              </p>
            </div>
